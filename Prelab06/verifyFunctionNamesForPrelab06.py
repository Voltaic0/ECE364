...
def runCheckAgainstStringFunctions():
    ...
    if printOut:
        ...
        message = f"The file '{fileName}' has been checked, and it does not contain any string functions."
...
def checkFunctionNames():
    ...
    functionNames = ['getUrlParts', 'getQueryParameters', 'getSpecial', 'getRealMAC', 'getRejectedEntries',
                     'getEmployeesWithIDs', 'getEmployeesWithoutIDs', 'getEmployeesWithPhones',
                     'getEmployeesWithStates', 'getCompleteEntries']

    # Attempt to import the code, and fail otherwise.
    try:
        import regexTasks as student
    except:
        print("-------------------------------")
